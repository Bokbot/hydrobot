...
class monitaur_i2c:
    ...
    default_address = 107 # the default address for the Arduino
...
def main():
    device = monitaur_i2c() # creates the I2C port object, specify the address or bus if necessary

    print(">> Atlas Scientific sample code")
    print(">> Any commands entered are passed to the board via I2C except:")
    print(">> Address,xx changes the I2C address the Raspberry Pi communicates with.")
    print(">> Poll,xx.x command continuously polls the board every xx.x seconds")
    print(" where xx.x is longer than the %0.2f second timeout." %  monitaur_i2c.long_timeout)
    ...
    while True:
        ...
        # contiuous polling command automatically polls the board
            ...
            if(delaytime < monitaur_i2c.long_timeout):
                print("Polling time is shorter than timeout, setting polling time to %0.2f" %  monitaur_i2c.long_timeout)
                delaytime =  monitaur_i2c.long_timeout
            ...
            try:
                while True:
                    ...
                    time.sleep(delaytime - monitaur_i2c.long_timeout)
